...
//            "",
    ...
    @PostMapping("/{boardType}/study/{studyIdx}")
    ...
    @GetMapping({"/{boardType}/{boardIdx}", "/{boardType}/study/{studyIdx}/{boardIdx}"})
    public ResponseEntity<CommonResponse> findByBoardInfo(@PathVariable("boardType") String boardType, @PathVariable("boardIdx") Long boardIdx, @PathVariable("studyIdx") Long studyIdx) {
    ...
    @GetMapping("/{boardType}/study/{studyIdx}")
    public ResponseEntity<CommonResponse> findByAll(@PathVariable("boardType") String boardType,
                                                    @PathVariable("studyIdx") Long studyIdx,
                                                    @RequestParam(value = "idx", required = false) Long idx,
                                                    @RequestParam(value = "size", required = false, defaultValue = "10") int size,
    ...
    @PatchMapping({"/{boardType}/{boardIdx}", "/{boardType}/study/{studyIdx}/{boardIdx}"})
    ...
    @DeleteMapping({"/{boardType}/{boardIdx}", "/{boardType}/study/{studyIdx}/{boardIdx}"})
