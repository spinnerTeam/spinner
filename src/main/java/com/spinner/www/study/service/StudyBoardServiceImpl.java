...
public class StudyBoardServiceImpl implements StudyBoardService {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> insert(String boardType, Long studyIdx, BoardCreateRequest boardRequest, List<MultipartFile> files) {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> insertReply(String boardType, Long studyIdx, ReplyCreateRequest replyRequest) {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> updateReply(String boardType, Long replyIdx, Long studyIdx, ReplyUpdateRequest replyRequest) {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> deleteReply(String boardType, Long replyIdx, Long studyIdx) {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> upsertLikeBoard(Long studyIdx, Long boardIdx) {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> upsertLikeReply(Long studyIdx, Long replyIdx) {
     ...
     */
    @Override
    public ResponseEntity<CommonResponse> upsertBookmarkBoard(Long studyIdx, Long boardIdx) {
